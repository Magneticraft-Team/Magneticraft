...
const val DATA_ID_MONITOR_HAS_KEY = 20
const val DATA_ID_MONITOR_KEY = 20
const val DATA_ID_MONITOR_MOUSE_CLICK = 21
const val DATA_ID_MONITOR_MOUSE_BUTTON = 22
const val DATA_ID_MONITOR_MOUSE_X = 23
const val DATA_ID_MONITOR_MOUSE_Y = 24
...
const val DATA_ID_THERMOPILE_SOURCE = 30
const val DATA_ID_THERMOPILE_DRAIN = 31

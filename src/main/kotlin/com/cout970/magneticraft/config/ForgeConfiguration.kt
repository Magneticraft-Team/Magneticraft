...
class ForgeConfiguration(file: File) : Configuration(file), IConfig {
    ...
    override fun getStringArray(category: String, key: String, defaultValue: Array<String>, comment: String) =
    ...
    override fun getStringArray(category: String, key: String, defaultValue: Array<String>, comment: String, validValues: Array<String>) =

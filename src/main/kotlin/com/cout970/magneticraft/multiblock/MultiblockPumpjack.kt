...
object MultiblockPumpjack : Multiblock() {
    ...
    val hitboxes = listOf(
            ...
            Vec3d(7.000, 46.000, -1.000) * PIXEL to Vec3d(11.000, 49.000, 17.000) * PIXEL,
            ...
            Vec3d(7.250, 17.000, 18.000) * PIXEL to Vec3d(11.250, 48.000, 20.000) * PIXEL,
            Vec3d(31.000, 19.678, -4.172) * PIXEL to Vec3d(42.000, 22.139, -1.711) * PIXEL,
            Vec3d(-12.000, 8.000, -13.000) * PIXEL to Vec3d(-2.000, 15.000, -3.000) * PIXEL,
            ...
            Vec3d(-9.000, 15.000, -10.000) * PIXEL to Vec3d(-5.000, 16.000, -6.000) * PIXEL,
            ...
            Vec3d(-2.000, 8.000, -8.000) * PIXEL to Vec3d(1.000, 9.000, -7.000) * PIXEL,
            Vec3d(-2.000, 8.000, -12.000) * PIXEL to Vec3d(1.000, 9.000, -11.000) * PIXEL,

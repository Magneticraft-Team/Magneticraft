 ...
 */
object BlockInfiniteCold : BlockBase(Material.ROCK, "infinite_cold"), ITileEntityProvider {

    override fun createNewTileEntity(worldIn: World?, meta: Int): TileEntity = TileInfiniteHeat(-50.toCelsiusFromFahrenheit())

...
public interface IElectricNode extends INode {
    ...
    /**
     * Returns an approximate value of the total flow of charge in this node in the last tick
     * this is only used to calculate the energy flowing through a wire
     *
     ...
     * This is not energy storage, this is used to calculate how long will take to fill the node with charge
     * The default value is 1.0
     */
    double getCapacity();

    /**
     * Adds or removes an amount of charge to the node
     * Current can be negative
     * All the charge will be added or removed completely
     *
    ...
    /**
     * Adds or removes energy from the node, returns the power added/removed

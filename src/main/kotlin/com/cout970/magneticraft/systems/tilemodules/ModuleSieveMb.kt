...
class ModuleSieveMb(
    ...
    fun getCapability(cap: Capability<*>, side: EnumFacing?, relPos: BlockPos): Any? {
        ...
        val connectorPos = facing.rotatePoint(BlockPos.ZERO, BlockPos(1, 1, -1))
    ...
    fun getConnectableDirections(): List<Pair<BlockPos, EnumFacing>> {
        return if (facing.rotateY().axisDirection == Direction.AxisDirection.NEGATIVE) {
            val pos = facing.rotatePoint(BlockPos.ZERO, BlockPos(2, 1, -1))
